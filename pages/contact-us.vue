        ...
        <div class="flex flex-wrap flex-col justify-center max-w-screen-xl m-auto md:px-4 md:py-8 border-b border-gray-400">
            <div class="flex flex-wrap flex-col w-full items-center justify-center">
                <div class="flex flex-wrap w-full items-start justify-center md:justify-between">
                    ...
                    <img src="/contact-us.jpeg" alt="Contact us" class="md:rounded-xl w-full md:w-2/5  aspect-16/9 md:aspect-square object-cover">
                    <!--Other content-->
                    <div class="flex flex-wrap flex-col w-10/12 md:w-3/5 md:pl-8 md:pr-4 pl-0 pr-0 py-4">
                        ...
                        <h2 class="info-label">
                            <span><font-awesome-icon :icon="['fas', 'phone']" class="mr-2 text-lg"/></span>
                            Phone
                        </h2>
                        <p class="info-content">
                            +39 02 2399 1
                        ...
                        <h2 class="info-label">
                            <span><font-awesome-icon :icon="['fas', 'envelope']" class="mr-2 text-lg"/></span>
                            Info Office
                        </h2>
                        <p class="info-content">
                            summer.school@polimi.it
                        </p>
                        ...
                        <p class="info-content">
                            summer.2024@polimi.it
                        </p>

                        <h2 class="info-label">
                            <span><font-awesome-icon :icon="['fas', 'money-bill']" class="mr-2 text-lg"/></span>
                            Cost
                        </h2>
                        <p class="info-content">
                            400€ per Week
